...
local Section = Tab:NewSection("Sell Reaper and wait  0.5 sec then click .")

Section:NewButton("Get money more", "Buy item Get cash", function()
...
Section:NewButton("Get Money more", "Buy item dupe cash", function()
...
end)Section:NewButton("Get Money more", "Buy item dupe cash", function()
...
Section:NewButton("Get most money", "Buy item dupe cash", function()
...
Section:NewButton("Buy Munneh (Money)", "Cost 50k", function()
    local args = {
        [1] = "Munneh"
    }
...
Section:NewButton("Buy MommehLongLegs (Mummy)", "Cost 500k", function()
    local args = {
        [1] = "Mommeh Long Legs"
    }
...
Section:NewKeybind("Open or close UI Press RightControl", "Open or close UI Press RightControl", Enum.KeyCode.RightControl, function()
    Library:ToggleUI()
end)
...
Section:NewButton("Scam Script", "WorkingNow", function()
